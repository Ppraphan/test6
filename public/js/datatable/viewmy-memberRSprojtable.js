...
$(document).ready(function() {
  ...
  /*init ตาราง*/
  var r_t = $('#view-memberRSProjTable').DataTable({
  ...
  $('#view-memberRSProjTable tbody').on('click', 'tr', function() {
            ...
            if (rows == '') {
              ...
              function addrows() {
                r_t.row.add([
                  ...
                  '<input type="hidden" id="idRSIDProj' + r_currentID + '" name="nameRSIDProj' + r_currentID + '" value=""/><input required type="text" id="nameProportionRS' + r_currentID + '" name="nameProportionRS' + r_currentID + '" placeholder="สัดส่วนงานวิจัย"autocomplete="off" />',
                ]).draw(false);
              }
